...
import { X, Mail, Chrome, Wallet, Eye, EyeOff, AlertCircle, CheckCircle, Info } from 'lucide-react';
...
export default function AuthModal({ isOpen, onClose, onWalletConnect }: AuthModalProps) {
  ...
  const handleGoogleAuth = async () => {
    ...
    try {
      ...
      setLocalError('Google sign-in encountered an error. Please try again or use email sign-in.');
      setLocalLoading(false);
    }
  };
            ...
            <>
              ...
              <div className="space-y-3">
                <button
                  ...
                  className="w-full flex items-center justify-center space-x-3 bg-white hover:bg-gray-100 disabled:bg-gray-300 text-gray-900 font-medium py-3 px-4 rounded-lg transition-colors disabled:cursor-not-allowed"
                >
